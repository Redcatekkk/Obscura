...
| M1-T1 | M1 | Plan.md §Frontend port rules, §Milestones M1 | APPROVED | 2026-05-23 | working tree commit pending | local verification | Static NULLBYTE-style UI shell implemented with mock data; `pnpm ci:frontend` and `pnpm ci:rust` exited 0. |
